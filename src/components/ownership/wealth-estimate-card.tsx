...
export function WealthEstimateCard({ property }: WealthEstimateCardProps) {
  const propertyData = property?.propertyProfile ?? null
  const marketValue = propertyData?.assessment?.market?.mktTtlValue || 0
