...
export function IndividualOwnerProfile({ ownerDetailsData }: IndividualOwnerProfileProps) {
              ...
              {phoneDetails.map((phone: any, index: number) => (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-muted-foreground mt-1">{phone?.last_reported}</div>
                  </div>
                </div>
              ))}
                  ...
                  {previousAddresses.map((address: any, index: number) => (
                    <div key={index} className="p-4 border rounded-lg">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <span className="text-xs text-muted-foreground">{address?.timespan}</span>
                      </div>
                    </div>
                  ))}
                </div>
