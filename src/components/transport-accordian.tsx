...
export function TransportationAccordion({
  transportationData,
  isOpen,
  onOpen,
  onClose,
  ...
  return (
    <Accordion
      ...
      collapsible
      className="w-full"
      value={isOpen ? 'transportation' : undefined}
      onValueChange={(val) => (val === 'transportation' ? onOpen() : onClose())}
    >
      <AccordionItem value="transportation">
        ...
        <AccordionContent>
          ...
          ) : error || (!isLoading && !transportationData) ? (
            <div className="text-center p-4 my-4 text-muted-foreground">
              Transportation Details not available for this property!
            </div>
          ) : (
                ...
                <Card>
                  <CardContent className="p-4 space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        className={getNoiseLevelColor(
                          transportationData?.rail_whistle_noise?.level
                        )}
                      >
